...
//  that wrote or XORed pixels.  B
//
//  param
//      pFrBufLine      Pointer to the beginning of the line of the FB.
//      ui32X           The X coordinate of the pixel.
//      ui32DrawingOps  A mask of the raster operations.
//      ui32DrawingOps  Drawing options/operations include:
//                      AM_UTIL_DRAW_ROPS_COPY   - Set the pixel to ui32Color.
//                      AM_UTIL_DRAW_ROPS_XOR    - XOR the pixel.
//                      AM_UTIL_DRAW_ROPS_OR     - OR the pixel.
//      ui32Color       The color to be used in setting the pixel.
//
//*****************************************************************************
/*
//
// Implement as a function.  Smaller, slower.
//
static void
modify_pixel_in_a_line(uint8_t *pFrBufLine,  uint32_t ui32X,
                       uint32_t ui32DrawingOps, uint32_t ui32Color,
                       uint32_t ui32DrawPolarity)
*/

//
// Implement as a macro.  Better performance, larger code size.
//
...
//*****************************************************************************
//
// brief Static support functions.
//
...
//!
//! @param ui32X,ui32Y = Coordinates of the desired pixel.
//!        ui32Color   = Color to write to the given pixel.
//!
//! @return None.
//
//*****************************************************************************
...
//!
//! @param
//!     pui8Bitmap        Pointer to the data array containing the bitmap.
//!     ui32Width         Width of the bitmap in pixels.
//!     ui32Height        Height of the bitmap in pixels.
//!     ui32DstX,ui32DstY The screen location to place the bitmap.
//!     ui32DrawingOps    Drawing options/operations include:
...
//!
//! @param
//!     ui16Char     = character to print.
//!     ui32X, ui32Y = The coordinates of the upper left corner of the char.
//!     ui32Color    = Color of the character.
//!
//! @return None.
//
//*****************************************************************************
...
//!
//! @param
//!     pui8Char       = Pointer to the null-terminated string to be printed.
//!     ui32X, ui32Y   = The upper left corner of the first character printed.
//!     ui32DrawingOps = AM_UTIL_DRAW_ROPS_COPY or AM_UTIL_DRAW_ROPS_XOR.
//!
...
//!
//! @param
//!     ui32DstX,ui32DstY = The upper left corner of the rectangle to be drawn.
//!     ui32Width         = Width of the rectangle, 1-96.
//!     ui32Height        = Height of the rectangle, 1-96.
//!     ui32Color         = Color of the rectangle.
//!     bFill             = If true, fill the rectangle.
//!
...
//!
//! @param
//!     ui32X1, ui32Y1 = One endpoint of the line.
//!     ui32X2, ui32Y2 = The other endpoint of the line.
//!     ui32Color      = Color of the line.
//!
//! @return true if successful, false otherwise.
//
//*****************************************************************************
...
//!
//! @param
//!     ui32X, ui32Y = Center of ellipse.
//!     ui32Xra d    = Radius of the X axis.
//!     ui32Yrad     = Radius of the Y axis.
//!     ui32Color    = Color of the line.
//!     bFill        = Filled if true, otherwise an outline.
//!
//! @return true if successful, false otherwise.
//
//*****************************************************************************
