...
//*****************************************************************************
//
//! @brief Delays for a desired number of clock cycles.
//!
//! @note This function is based on the similar function in am_util_delay.c,
//! please see that module for implementation details.
//!
//! @returns None
//
//*****************************************************************************
...
am_itm_delay_cycles(uint32_t ui32Cycles)
{
    __asm("    subs    r0, #1\n"
          "    bne     am_itm_delay_cycles\n"
          "    bx      lr");
}
#endif
#ifdef keil
