...
extern void am_hal_iom_i2c_write_nb(uint32_t ui32Module, uint32_t ui32ChipSelect,
                                    uint32_t *pui32Data, uint32_t ui32NumBytes,
                                    uint32_t ui32Options,
                                    am_hal_iom_callback_t pfnCallback);

extern void am_hal_iom_i2c_read_nb(uint32_t ui32Module, uint32_t ui32ChipSelect,
                                   uint32_t *pui32Data, uint32_t ui32NumBytes,
                                   uint32_t ui32Options,
                                   am_hal_iom_callback_t pfnCallback);
...
#define am_hal_iom_pwrctrl_enable(ui32Module)
#define am_hal_iom_pwrctrl_disable(ui32Module)
#define am_hal_iom_power_on_restore(ui32Module)
#define am_hal_iom_power_off_save(ui32Module)
