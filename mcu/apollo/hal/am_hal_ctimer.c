                          ...
                          uint32_t ui32CompareReg, uint32_t ui32Value)
{
    ...
    //
    // Only take a 16-bit compare value.
    //
    ui32ConfigVal = ui32Value & 0x0000FFFF;
    ...
    {
        *pui32ConfigReg =
            (((*pui32ConfigReg) & AM_REG_CTIMER_CMPRA0_CMPR0A0_M) |
             AM_REG_CTIMER_CMPRA0_CMPR1A0(ui32ConfigVal));
    }
    else
    {
        *pui32ConfigReg =
            (AM_REG_CTIMER_CMPRA0_CMPR0A0(ui32ConfigVal) |
             ((*pui32ConfigReg) & AM_REG_CTIMER_CMPRA0_CMPR1A0_M));
    }
}
