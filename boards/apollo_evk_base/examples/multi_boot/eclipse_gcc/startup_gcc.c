...
extern void am_mpufault_isr(void) __attribute ((weak));
extern void am_busfault_isr(void) __attribute ((weak));
extern void am_usagefault_isr(void) __attribute ((weak, alias ("am_default_isr")));
